...
三、bug 构型（伯氏守恒版）
-----------------------------------------------------------------------------
一条 ~800 b 的钉扎臂，b=1/2[1 0 -1]，滑移面 (111)：
...
-----------------------------------------------------------------------------
build_screw_chains 用整臂首尾弦向量判螺型：弦向与 b 夹角 ~21.5°(>15°) -> 整条臂被判
...
def build_bent_arm_network(L_box=4000.0):
    ...
    P = np.array([
        ...
        [332.286, 115.089, -447.375],            # 5..6：拐弯，非螺型
        [311.018, 230.179, -541.196],            # 6..7：拐弯，非螺型
    ])
