...
# ========== 在这里修改路径 ==========
input_dir  = '/data/home/dg000246d/Opendis_q/a_test_cross_slip/yes_vis/output_with_cross_slip'   # .data 文件所在目录
output_dir = '/data/home/dg000246d/Opendis_q/a_test_cross_slip/yes_vis/vtk'      # .vtk 文件保存目录
# ====================================
