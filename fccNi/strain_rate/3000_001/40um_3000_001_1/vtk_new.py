...
# ========== 在这里修改路径和范围 ==========
input_dir  = '/data/home/dg000246d/Opendis_q/fccNi/strain_rate/3000_011/40um_3000_011_1/40um_3000_011_1_output/output'
output_dir = '/data/home/dg000246d/Opendis_q/fccNi/strain_rate/3000_011/40um_3000_011_1/40um_3000_011_1_vtk'

# ---- 转换范围设置（直接填文件名，留空则全部转换） ----
start_file = 'config.0.data'   # 起始文件名（例如 'config.0.data'），设为 None 则从第一个开始
end_file   = 'config.700.data'  # 结束文件名（例如 'config.50.data'），设为 None 则到最后一个
step       = 1                 # 步长，默认 1
# ======================================================
