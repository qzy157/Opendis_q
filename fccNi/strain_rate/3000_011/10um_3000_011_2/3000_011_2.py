...
def fcc_Ni_10um_3e3_001():
    ...
    erate = 3000.0
    edir = np.array([0., 1., 1.])  # [011] 加载方向
    output_dir = 'output'

    restart_id = sys.argv[1] if len(sys.argv) > 1 else None
    if restart_id is None:
        # 初始构型：relax_2 松弛后的位错网络
        data_filename = '/data/home/dg000246d/Opendis_q/fccNi/relax/10um_relax_2/output/config.30600.data'
