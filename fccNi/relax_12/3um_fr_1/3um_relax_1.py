...
def fcc_Ni_3um_relax():
    ...
    G.read_data('/data/home/dg000246d/Opendis_q/fccNi/init_12/3um_fr_1/fcc_Ni_3um_3e12_frank_read_1.data')#读取 ParaDiS 格式的 .data 文件。read_data 就是 read_paradis（pyexadis_base.py:75-78）：C++ 端解析文件后生成一个新网络，替换掉 G.net 里的空网络。 
