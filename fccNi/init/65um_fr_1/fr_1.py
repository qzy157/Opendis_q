...
def fcc_Ni_65um_frank_read():
    ...
    write_vtk(net, os.path.join(script_dir, 'fcc_Ni_65um_1e10_frank_read_1.vtk'), crystal='FCC')
    write_data(net, os.path.join(script_dir, 'fcc_Ni_65um_1e10_frank_read_1.data'))
    pyexadis.finalize()


if __name__ == "__main__":
    fcc_Ni_65um_frank_read()
