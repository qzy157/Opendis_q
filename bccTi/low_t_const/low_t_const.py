...
def bcc_Ti_3um_3e3():
    ...
    if restart_id is None:
        ...
        data_filename = '../relax_low_t/output/config.90000.data'#看图要在要在120µs以后，采取config3800
    ...
    mobility  = MobilityLaw(mobility_law='BCC_0B_TEMP', state=state, Mclimb=1e-6, kT=0.0, bT=298.0, vmax=3400.0)#温度KT=0.0K，bT=298.0K（起始温度为25℃，没有温度变化）
